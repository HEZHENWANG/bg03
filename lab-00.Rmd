...
```{r setup-tibble}
team_data <- tibble(
  name = c("Emma", "XiChen", "Hani", 
           "Yankun", "TANKI"),
  github_username = c("taoran06", "XiChen0612", "haniman26", 
                      "Shuangyk", "Tankizzz"), 
  colour = c("blue", "purple", "white", 
             "blue", "yellow"),
  hobby = c("singing", "jogging", "solving puzzles", 
            "gaming", "soccer"),
  favourite_number = c(2, 3, 6, 5, 7)
  )
